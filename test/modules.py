...
from D import build_deeplabv3_plus as network
def segment(file_list):
    ...
    images = ["./CamVid_people/test/0001TP_007170.png", "./CamVid_people/test/0001TP_007860.png", "./CamVid_people/test/0001TP_008070.png"]
    for image in images:
